function SudokuGenerator(){
    ...
    this.newStartingBoard = function (holes) {
    ...
    this.pokeHoles = function (startingBoard, holes) {
        const removedVals = []
    ...
    this.fillPuzzle = function (startingBoard) {
        ...
        for (num of this.shuffle(numArray)) {
    ...
    this.nextEmptyCell = function(puzzleArray){
        const emptyCell = { 
            rowIndex: "", 
            colIndex: "" 
        }
    ...
    this.safeToPlace = function(puzzleArray, emptyCell, num){
    ...
    this.rowSafe = function(puzzleArray, emptyCell, num){
        return puzzleArray[ emptyCell.rowIndex ].indexOf(num) == -1
    }
    
    this.colSafe = function(puzzleArray, emptyCell, num){
        return !puzzleArray.some(row => row[ emptyCell.colIndex ] == num )
    }
    
    this.boxSafe = function(puzzleArray, emptyCell, num){
